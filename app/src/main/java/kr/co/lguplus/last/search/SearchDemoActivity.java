...
public class SearchDemoActivity extends FragmentActivity implements  MapView.MapViewEventListener, MapView.POIItemEventListener,MapReverseGeoCoder.ReverseGeoCodingResultListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton searchbtn = (ImageButton) findViewById(R.id.search_search_btn);
        ImageButton alarmbtn = (ImageButton) findViewById(R.id.search_alarm_btn);
        ...
        talkbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SearchDemoActivity.this, MessageActivity.class);
                startActivity(intent);
        ...
        searchbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SearchDemoActivity.this, SearchDemoActivity.class);
                startActivity(intent);
        ...
        alarmbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SearchDemoActivity.this, AlarmActivity.class);
                startActivity(intent);
        ...
        studybtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SearchDemoActivity.this, StudyListActivity.class);
                startActivity(intent);
        ...
        billbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SearchDemoActivity.this, PayActivity.class);
                startActivity(intent);
